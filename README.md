...
```text
No. Trick question almost. p1 and p2 do not access the same memory location, even if they're both in Point. p1 is in the center, p2 is only for after it's growth.
``
